...
object OpenProjectCmdLineTestBazel
...
// JDK11 only!
class OpenProjectCmdLineTestBazel extends BazelTestSuite with OpenProjectTest {

  override def intelliJ: RunningIntelliJFixture = OpenProjectCmdLineTestBazel.intelliJ
